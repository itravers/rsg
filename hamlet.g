...
p2 - that is the question .
p3 - weather 'tis nobler in the mind 
p4 - to suffer the slings and arrows
p4a - of outrageous fortunes
p5 - or to take arms against a sea of troubles
p6 - and by opposing end them 
p7 - and by a sleep to say we end the heartache and a thousand natural shocks that flesh is heir to
p8 - tis a consummation devoutly to be wished
p9 - to sleep, perchance to dream
p10 - 'aye, there's the rub 
p11 - for in that sleep of death
p12 - what dreams may come
p13 - when we have shuffled off this mortal coil
p14 - must give us pause
p15 - There's the respect
p16 - that makes calamity
p17 - of so long life

p18 - for who would bear
p19 - the whips and scorns of time

p20 - the oppressors wrongs
p21 - the proud mans contumely
p22 - the pangs of despised love
p23 - the laws delay
...
at the <hands> of the <unworthy> ;
are <caused> by the <unworthy> ;
}
...
<Should> I <suffer> , or <suicide>	;
Why should I <continue> <living> like this ;
...
It's what I've been <wondering> <lately> ;
...
to <suffer> all the <hurts> and <disappointments> ;
}

{
<p4a>
of <outrageous> <fortunes> ;
of <bad> <things> that <happen> ;
of a <bad> <life> ;
}
...
Or to <suicide> <because-of> <troubles> ;
}
...
I <want> this <more> <anything> ;
}

{
<p9>
To <sleep> , <perchance> <to-dream> ;
While in this <sleep> , I could possibly have a <dream> ;
There is the chance that I could have a <dream> while I'm in this <sleep> ;
}

{
<p10>
<aye> , there's the <rub> ;
That's where the <rub> may <occur> ;
I may have a lot of <rub> if I <sleep> ;
}

{
<p11>
for in that <sleep> of <death> ;
while I am in my <sleep> ;
}

{
<p12>
what <dream> may come ;
what <bullshit> could <happen> ;
}
...
when we <die> ;
when <death> <consumes> us ;
when this <life> comes to a <end> ;
}

{
<p14>
<must> <give> us <pause> ;
<must> <make-us> to <retreat> and <think> for a <minute> ;
<must> <slow> the <process> ;
}

{
<p15>
There's the <respect> ;
This <may> be the <respect> ;
}
...
<p17>
of so <long> <life> ;
of <dwelling> on this <coil> for too much time ;
}

{
<p18>
For who would <put-up-with> ;
Who could <suffer> to stand up to ;
Why <Should> I <continue> dealing with ;
}
...
the <abuse> that is <accumulated> ;
}

{
<p20>
the <oppressors> <abuse> ;
<bad> people's <anger> ;
}

{
<p21>
the <proud> <mans> <scorns> ;
the <avarice> of the <average> <rich> <person> ;
}

{
<p22>
The <pangs> of <despised> <love> ;
The <pain> <caused> by <giving> <love> to a <person> that does not <love2> <back> ;
}

{
<p23>
the <laws> <delay> ;
the <time> it takes for a <case> to <filter> through the <courts> ;
}

{
<p24>
The <scorns> of <office> ;
When <people> in <positions> of <authority> are <disrespectful> to me ;
}

{
<p25>
and the <spurns> that the <patient> <merit> ;
and when <things> that are <bad> <happen> to <patient> <people> ;
}
...
life itself ;
sex ;
being <naked> in <bed> with a <beautiful> <woman> ;
}
...
<step> in front of a <moving> <truck> ;
<shoot> myself ;
<jump> off a <bridge> ;
}
...
figure this out ;
ponder this ;
get down to brass tacks on this ;
judge this ;
resolve this ;
kick this around ;
walk through this ;
